...
<meta name="description" content="Experience the sophistication of finely crafted granite and natural stone at SGS - Supreme Granites and Stone. Visit us in Bangalore or browse our gallery to find the perfect stone for your project.">
<title>Granite & Natural Stone</title>
            ...
            <div class="container-fluid d-flex justify-content-between">
                <div class="logo d-flex align-items-center">
                    ...
                    <div class="logo-text">
                        ...
                        <span class="ms-2">Granites & Stone</span>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div style="display: flex; justify-content: space-between;">
                                <div style="width: 70%;">
                                    <h1>About Us</h1>
                                    <p>
                                        <strong>Supreme Granites & Stones</strong> is a leading supplier of <strong>premium granite</strong> and <strong>natural stone</strong> in Bangalore. We offer a wide range of products including <strong>Granite</strong> & <strong>Stones</strong>. Our products are sourced from the best quarries around the world and are known for their <strong>quality</strong>, <strong>durability</strong>, and <strong>beauty</strong>.
                                    </p>
                                    <p>
                                        We cater to both:
                                        <ul>
                                ...
                                <div style="width: 30%; padding-left: 20px; line-height:40px">
                                    <h2>Why Choose Us?</h2>
                                    <ul>
                            ...
                            <h5>Locations We Trade :</h5>
                            <div class="row text-center mb-3">
                                <!-- text - Locations we trade -->
                                
                                <div class="col">
                                    <i class="fas fa-truck"></i> Madurai, Tamil Nadu
                                </div>
                                <div class="col">
                                    <i class="fas fa-truck"></i> Ilkal, Karnataka
                                </div>
                                <div class="col">
                                    <i class="fas fa-truck"></i> Ongale, Srikakulam (Andhra Pradesh)
                                </div>
                                <div class="col">
                                    <i class="fas fa-truck"></i> Warangal, Karimnagar (Telengana)
                                </div>
                                <div class="col">
                                    <i class="fas fa-truck"></i> Kishangarh (Rajasthan)
                                </div>
                            </div>
                            <p>
